...
import { Ship, Settings, GitBranch, Bell, LogOut, Plus, Menu, X } from 'lucide-react';
      ...
      <main className="lg:ml-64 p-4 lg:p-8 pt-20 lg:pt-8">
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
            ...
            <button className="bg-teal-600 text-white px-4 py-2 rounded-lg hover:bg-teal-500 transition flex items-center justify-center gap-2 w-full sm:w-auto">
          ...
          {mockRepos.length === 0 && (
            <div className="bg-white rounded-xl p-8 lg:p-12 text-center border border-navy-100">
              ...
              <button className="bg-navy-900 text-white px-6 py-3 rounded-lg hover:bg-navy-800 transition w-full sm:w-auto">
                Connect Repository
              </button>
            </div>
          )}
